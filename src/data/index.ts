...
export const packages = [
  {
    ...
    name: "Starter",
    price: "Rs 6,000",
    priceNote: "Demo pricing. Add Rs 500 if we arrange domain + hosting.",
  ...
  },
  {
    ...
    name: "Business",
    price: "Rs 8,000",
    priceNote: "Demo pricing. Add Rs 700 if we arrange domain + hosting.",
  ...
  },
  {
    ...
    name: "Premium",
    price: "Rs 12,000",
    priceNote: "Demo pricing. Add Rs 900 if we arrange domain + hosting.",
    ...
    features: [
      ...
      "Custom domain connection + launch support",
